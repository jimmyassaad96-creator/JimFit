...
import { enablePushForUser, notifyTrainer, recalcBmrAndTargets } from "../data/queries.js";
...
import { CLIENT_DIET_SUBTAB_KEY, CLIENT_PROGRAMS_SUBTAB_KEY, CLIENT_PROGRESS_SUBTAB_KEY, CLIENT_TAB_KEY, PENDING_GYM_CREATE_KEY, PENDING_TRAINER_CREATE_KEY, PREF_KEY, TRAINER_ROLE_ASSERT_KEY, computePersonalRecords, computePrevWeekVolume, computeWeekVolume, daysAgoISO, daysSince, guessMuscleGroup, hasSelfTrainAppAccess, hasSelfTrainPaidAccess, musclesForWorkoutTitle, openSupportEmail, parseQuickSets, randomInviteCode, summarizeSetsForFlash } from "../domain/rules.js";
...
import { AuthGate, ProfileGate, ResetPasswordScreen, WelcomeGate } from "../modules/auth/index.js";
import { ClientCustomProgramCard, ClientInjuriesPanel } from "../modules/clients/index.js";
...
import { FindTrainerPanel, InfoSectionCard, SelfTrainAccessLockedScreen, TrainerFirstPaymentDueScreen, TrainerNotOnRosterScreen, TrainerPaymentOverdueScreen, TrainerPendingApprovalScreen } from "../modules/trainers/index.js";
...
import { ConfirmDialog, Icon, Select } from "../shared/ui/cross.js";
import { EditableStat, ExercisePicker, PaymentStatusStepper, SmartVoiceEntryButton } from "../shared/widgets/index.js";
