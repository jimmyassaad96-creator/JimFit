...
import { AuthGate, PENDING_GYM_CREATE_KEY, PENDING_TRAINER_CREATE_KEY, ProfileGate, ResetPasswordScreen, WelcomeGate } from "../modules/auth/index.js";
import { CLIENT_DIET_SUBTAB_KEY, CLIENT_PROGRAMS_SUBTAB_KEY, CLIENT_PROGRESS_SUBTAB_KEY, CLIENT_TAB_KEY, ClientCustomProgramCard, ClientInjuriesPanel } from "../modules/clients/index.js";
import { DietPanel } from "../modules/diet/DietPanel.js";
import { DietLogPanel } from "../modules/diet/index.js";
import { LogFeed, SessionGoalCard, TrainingHeatmap } from "../modules/logging/index.js";
import { InjuryReminderBanner, MilestoneBadges, PushOnboardingGate, notifyTrainer } from "../modules/notifications/index.js";
import { PaymentStatusStepper, PaymentsPanel } from "../modules/payments/index.js";
import { ProgramsPanel } from "../modules/programs/ProgramsPanel.js";
import { ExercisePicker } from "../modules/programs/index.js";
import { AssessmentPanel, CheckInPanel, MeasurementsPanel, PersonalRecordsPanel, ProgressPanel, StatsPanel, ThisWeekCard, WeeklyRecapCard } from "../modules/progress/index.js";
import { TrainerView } from "../modules/trainers/TrainerView.js";
import { FindTrainerPanel, SelfTrainAccessLockedScreen, TRAINER_ROLE_ASSERT_KEY, TrainerFirstPaymentDueScreen, TrainerNotOnRosterScreen, TrainerPaymentOverdueScreen, TrainerPendingApprovalScreen } from "../modules/trainers/index.js";
import { ProfileVoiceEntryButton, SmartVoiceEntryButton, VoiceConfirmPopup } from "../modules/voice/index.js";
...
import { PREF_KEY, computePersonalRecords, computePrevWeekVolume, computeWeekVolume, daysAgoISO, daysSince, enablePushForUser, guessMuscleGroup, hasSelfTrainAppAccess, hasSelfTrainPaidAccess, musclesForWorkoutTitle, openSupportEmail, parseQuickSets, randomInviteCode, summarizeSetsForFlash } from "../shared/lib/misc.js";
